...
//https://www.youtube.com/watch?v=eEU6gae494Y
// Thanks to AOS Note
...
resource "null_resource" "name" {
  ...
  connection {
    type        = "ssh"
    user        = "ec2-user"
    private_key = file("~/Documents/aws-secrets/ec2-key.pem")
  ...
  provisioner "file" {
    source      = "~/Documents/aws-secrets/docker-pw.txt"
    destination = "/home/ec2-user/docker-pw.txt"
  }
